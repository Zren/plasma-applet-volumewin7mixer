...
# Author: @Valodim (Vincent Breitmoser), released under LGPL
# @Zren modified __all__ to export STRING
# @Zren modified for Python3
...
PA_PROP_WINDOW_DESKTOP = b'window.desktop' # Variable STRING '(const char*)"window.desktop"'
PA_NSEC_PER_SEC = 1000000000 # Variable c_ulonglong '1000000000ull'
PA_PROP_WINDOW_ICON = b'window.icon' # Variable STRING '(const char*)"window.icon"'
PA_NSEC_PER_MSEC = 1000000 # Variable c_ulonglong '1000000ull'
PA_USEC_PER_MSEC = 1000 # Variable c_ulong '1000u'
PA_PROP_DEVICE_BUFFERING_BUFFER_SIZE = b'device.buffering.buffer_size' # Variable STRING '(const char*)"device.buffering.buffer_size"'
PA_VOLUME_MUTED = 0 # Variable c_uint '0u'
PA_PROP_WINDOW_HPOS = b'window.hpos' # Variable STRING '(const char*)"window.hpos"'
PA_PROP_DEVICE_CLASS = b'device.class' # Variable STRING '(const char*)"device.class"'
PA_USEC_PER_SEC = 1000000 # Variable c_ulong '1000000u'
PA_PROP_WINDOW_X11_DISPLAY = b'window.x11.display' # Variable STRING '(const char*)"window.x11.display"'
PA_PROP_DEVICE_VENDOR_ID = b'device.vendor.id' # Variable STRING '(const char*)"device.vendor.id"'
PA_PROP_FILTER_SUPPRESS = b'filter.suppress' # Variable STRING '(const char*)"filter.suppress"'
PA_PROP_FORMAT_CHANNEL_MAP = b'format.channel_map' # Variable STRING '(const char*)"format.channel_map"'
PA_PROP_DEVICE_BUFFERING_FRAGMENT_SIZE = b'device.buffering.fragment_size' # Variable STRING '(const char*)"device.buffering.fragment_size"'
PA_PROP_DEVICE_PROFILE_DESCRIPTION = b'device.profile.description' # Variable STRING '(const char*)"device.profile.description"'
PA_PROP_MEDIA_ICON = b'media.icon' # Variable STRING '(const char*)"media.icon"'
PA_PROP_DEVICE_PRODUCT_ID = b'device.product.id' # Variable STRING '(const char*)"device.product.id"'
PA_PROP_FILTER_APPLY = b'filter.apply' # Variable STRING '(const char*)"filter.apply"'
PA_PROP_WINDOW_VPOS = b'window.vpos' # Variable STRING '(const char*)"window.vpos"'
PA_PROP_DEVICE_BUS_PATH = b'device.bus_path' # Variable STRING '(const char*)"device.bus_path"'
PA_PROP_APPLICATION_PROCESS_MACHINE_ID = b'application.process.machine_id' # Variable STRING '(const char*)"application.process.machine_id"'
PA_PROP_WINDOW_Y = b'window.y' # Variable STRING '(const char*)"window.y"'
PA_PROP_WINDOW_X = b'window.x' # Variable STRING '(const char*)"window.x"'
PA_PROP_APPLICATION_PROCESS_ID = b'application.process.id' # Variable STRING '(const char*)"application.process.id"'
PA_PROP_MEDIA_ICON_NAME = b'media.icon_name' # Variable STRING '(const char*)"media.icon_name"'
PA_CVOLUME_SNPRINT_MAX = 320 # Variable c_int '320'
PA_RATE_MAX = 192000 # Variable c_uint '192000u'
PA_MICRO = 0 # Variable c_int '0'
PA_PROP_APPLICATION_ICON_NAME = b'application.icon_name' # Variable STRING '(const char*)"application.icon_name"'
PA_PROP_MODULE_VERSION = b'module.version' # Variable STRING '(const char*)"module.version"'
PA_INVALID_INDEX = 4294967295 # Variable c_uint '4294967295u'
PA_PROP_APPLICATION_PROCESS_HOST = b'application.process.host' # Variable STRING '(const char*)"application.process.host"'
PA_PROP_DEVICE_ICON = b'device.icon' # Variable STRING '(const char*)"device.icon"'
PA_PROP_WINDOW_X11_SCREEN = b'window.x11.screen' # Variable STRING '(const char*)"window.x11.screen"'
PA_USEC_INVALID = 18446744073709551615 # Variable c_ulong '-1u'
PA_PROP_APPLICATION_LANGUAGE = b'application.language' # Variable STRING '(const char*)"application.language"'
PA_PROP_WINDOW_WIDTH = b'window.width' # Variable STRING '(const char*)"window.width"'
PA_PROP_DEVICE_STRING = b'device.string' # Variable STRING '(const char*)"device.string"'
PA_PROP_DEVICE_BUS = b'device.bus' # Variable STRING '(const char*)"device.bus"'
PA_PROTOCOL_VERSION = 23 # Variable c_int '23'
PA_PROP_MEDIA_ROLE = b'media.role' # Variable STRING '(const char*)"media.role"'
PA_MINOR = 1 # Variable c_int '1'
PA_PROP_EVENT_MOUSE_VPOS = b'event.mouse.vpos' # Variable STRING '(const char*)"event.mouse.vpos"'
PA_PROP_MEDIA_ARTIST = b'media.artist' # Variable STRING '(const char*)"media.artist"'
PA_PROP_MEDIA_SOFTWARE = b'media.software' # Variable STRING '(const char*)"media.software"'
PA_PROP_APPLICATION_ID = b'application.id' # Variable STRING '(const char*)"application.id"'
PA_DECIBEL_MININFTY = -200.0 # Variable c_double '-2.0e+2'
PA_PROP_WINDOW_NAME = b'window.name' # Variable STRING '(const char*)"window.name"'
PA_NSEC_PER_USEC = 1000 # Variable c_ulonglong '1000ull'
PA_API_VERSION = 12 # Variable c_int '12'
PA_PROP_WINDOW_X11_XID = b'window.x11.xid' # Variable STRING '(const char*)"window.x11.xid"'
PA_VOLUME_NORM = 65536 # Variable c_uint '65536u'
PA_PROP_EVENT_MOUSE_BUTTON = b'event.mouse.button' # Variable STRING '(const char*)"event.mouse.button"'
PA_PROP_APPLICATION_PROCESS_USER = b'application.process.user' # Variable STRING '(const char*)"application.process.user"'
PA_PROP_APPLICATION_ICON = b'application.icon' # Variable STRING '(const char*)"application.icon"'
PA_PROP_WINDOW_X11_MONITOR = b'window.x11.monitor' # Variable STRING '(const char*)"window.x11.monitor"'
PA_STREAM_EVENT_REQUEST_CORK = 'request-cork' # Variable STRING '(const char*)"request-cork"'
PA_PROP_MEDIA_FILENAME = b'media.filename' # Variable STRING '(const char*)"media.filename"'
PA_PROP_FORMAT_SAMPLE_FORMAT = b'format.sample_format' # Variable STRING '(const char*)"format.sample_format"'
PA_CHANNEL_MAP_SNPRINT_MAX = 336 # Variable c_int '336'
PA_PROP_MEDIA_TITLE = b'media.title' # Variable STRING '(const char*)"media.title"'
PA_PROP_EVENT_MOUSE_X = b'event.mouse.x' # Variable STRING '(const char*)"event.mouse.x"'
PA_SAMPLE_SPEC_SNPRINT_MAX = 32 # Variable c_int '32'
PA_PROP_EVENT_MOUSE_Y = b'event.mouse.y' # Variable STRING '(const char*)"event.mouse.y"'
PA_PROP_FILTER_WANT = b'filter.want' # Variable STRING '(const char*)"filter.want"'
PA_PROP_MODULE_USAGE = b'module.usage' # Variable STRING '(const char*)"module.usage"'
PA_PROP_WINDOW_ID = b'window.id' # Variable STRING '(const char*)"window.id"'
PA_PROP_DEVICE_API = b'device.api' # Variable STRING '(const char*)"device.api"'
PA_PROP_EVENT_DESCRIPTION = b'event.description' # Variable STRING '(const char*)"event.description"'
PA_PROP_DEVICE_ACCESS_MODE = b'device.access_mode' # Variable STRING '(const char*)"device.access_mode"'
PA_PROP_EVENT_MOUSE_HPOS = b'event.mouse.hpos' # Variable STRING '(const char*)"event.mouse.hpos"'
PA_PROP_DEVICE_MASTER_DEVICE = b'device.master_device' # Variable STRING '(const char*)"device.master_device"'
PA_PROP_FORMAT_RATE = b'format.rate' # Variable STRING '(const char*)"format.rate"'
PA_PROP_DEVICE_PROFILE_NAME = b'device.profile.name' # Variable STRING '(const char*)"device.profile.name"'
PA_STREAM_EVENT_REQUEST_UNCORK = 'request-uncork' # Variable STRING '(const char*)"request-uncork"'
PA_PROP_EVENT_ID = b'event.id' # Variable STRING '(const char*)"event.id"'
PA_BYTES_SNPRINT_MAX = 11 # Variable c_int '11'
PA_PROP_DEVICE_FORM_FACTOR = b'device.form_factor' # Variable STRING '(const char*)"device.form_factor"'
PA_PROP_APPLICATION_PROCESS_SESSION_ID = b'application.process.session_id' # Variable STRING '(const char*)"application.process.session_id"'
PA_USEC_MAX = 18446744073709551614 # Variable c_ulong '-2u'
PA_PROP_FORMAT_CHANNELS = b'format.channels' # Variable STRING '(const char*)"format.channels"'
PA_PROP_MEDIA_NAME = b'media.name' # Variable STRING '(const char*)"media.name"'
PA_VOLUME_SNPRINT_MAX = 10 # Variable c_int '10'
PA_PROP_DEVICE_SERIAL = b'device.serial' # Variable STRING '(const char*)"device.serial"'
PA_STREAM_EVENT_FORMAT_LOST = 'format-lost' # Variable STRING '(const char*)"format-lost"'
PA_PROP_APPLICATION_VERSION = b'application.version' # Variable STRING '(const char*)"application.version"'
PA_PROP_DEVICE_PRODUCT_NAME = b'device.product.name' # Variable STRING '(const char*)"device.product.name"'
PA_PROP_MODULE_AUTHOR = b'module.author' # Variable STRING '(const char*)"module.author"'
PA_PROP_WINDOW_ICON_NAME = b'window.icon_name' # Variable STRING '(const char*)"window.icon_name"'
PA_MAJOR = 1 # Variable c_int '1'
PA_MSEC_PER_SEC = 1000 # Variable c_ulong '1000u'
PA_PROP_DEVICE_VENDOR_NAME = b'device.vendor.name' # Variable STRING '(const char*)"device.vendor.name"'
PA_PROP_DEVICE_INTENDED_ROLES = b'device.intended_roles' # Variable STRING '(const char*)"device.intended_roles"'
PA_SW_CVOLUME_SNPRINT_DB_MAX = 448 # Variable c_int '448'
PA_PROP_DEVICE_DESCRIPTION = b'device.description' # Variable STRING '(const char*)"device.description"'
PA_PROP_APPLICATION_NAME = b'application.name' # Variable STRING '(const char*)"application.name"'
PA_PROP_DEVICE_ICON_NAME = b'device.icon_name' # Variable STRING '(const char*)"device.icon_name"'
PA_PROP_MODULE_DESCRIPTION = b'module.description' # Variable STRING '(const char*)"module.description"'
PA_FORMAT_INFO_SNPRINT_MAX = 256 # Variable c_int '256'
PA_PROP_APPLICATION_PROCESS_BINARY = b'application.process.binary' # Variable STRING '(const char*)"application.process.binary"'
PA_PROP_WINDOW_HEIGHT = b'window.height' # Variable STRING '(const char*)"window.height"'
PA_PROP_MEDIA_COPYRIGHT = b'media.copyright' # Variable STRING '(const char*)"media.copyright"'
PA_SW_VOLUME_SNPRINT_DB_MAX = 10 # Variable c_int '10'
PA_PROP_MEDIA_LANGUAGE = b'media.language' # Variable STRING '(const char*)"media.language"'
pollfd._fields_ = [
]
